    ...
    <div class="container" id="root">
      <div class="row">
        <div class="col-6 offset-3">
          <br /><br />
          <div class="card">
            <div class="todo-title">Todo Lists</div>
            <div class="card-body">
              <form v-on:submit.prevent>
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    ...
                    >
                      <span
                        :class="{'fa fa-plus' : !enableEdit, 'fa fa-edit' : enableEdit}"
                      ></span>
                    </button>
                  </span>
                </div>
              ...
              <ul class="list-group">
                ...
                >
                  <i
                    :class="{'fa fa-circle': !todo.completed, 'fa fa-check-circle text-success': todo.completed }"
                    >&nbsp;</i
                  >
                  <span :class="{ 'del': todo.completed }"
                    >@{ todo.title }</span
                  >
                  <div
        ...
        methods: {
          addTodo() {
            if (this.todo.title == "") {
              ...
              if (this.enableEdit) {
                this.$http
                  .put("todo/" + this.todo.id, this.todo)
                  .then((response) => {
                ...
                this.$http
                  .post("todo", { title: this.todo.title })
                  .then((response) => {
